...
class AddNos extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
       var data = {
        ...
        this.props.addParts(this.props.adminToken,data,'/addNos');
...
const AddNosComponent = connect(mapStateToProps, {getAllParts,addParts})(AddNos);
export default AddNosComponent;
