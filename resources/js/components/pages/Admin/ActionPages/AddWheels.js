...
class AddWheels extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
       var data = {
        ...
        this.props.addParts(this.props.adminToken,data,'/addWheels');
            ...
            <div className={"row"}>
                <div className={"col-sm-12"}>
                    <div className={"admin_add_action"}>
                        <span className={"add-action-label"}>Prideti ratus</span>
...
const AddWheelsComponent = connect(mapStateToProps, {getAllParts,addParts})(AddWheels);
export default AddWheelsComponent;
